// Example pallet for the Ontochain Hackathon.
// Making use of the substrate offchain worker example pallet  --> https://github.com/paritytech/substrate/tree/master/frame/examples/offchain-worker
...
pub const KEY_TYPE: KeyTypeId = KeyTypeId(*b"onto!");
...
impl<T: Config> Pallet<T> {
	...
	fn fetch_price() -> Result<u32, http::Error> {
		...
		let request =
			http::Request::get("https://ontochain.recheck.io/shares/1a8f6270-9898-41ee-8fb9-4bd8e96253ce");
