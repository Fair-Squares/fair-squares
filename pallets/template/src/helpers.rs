...
impl<T: Config> Pallet<T> {
    ...
    //Helper function for account creation rejection by admin only
     ...
     //pub fn select_owners() -> Vec<T::AccountId>{}

     //In the storage DMC::ReferenfumInfoOf, get the enum ReferendumInfo
     //pub fn get_referendum_status(referendum_index: DMC::ReferendumIndex) -> bool{
     //   DMC::ReferendumInfoOf::<T>::get(referendum_index);
     //}
