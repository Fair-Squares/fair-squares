...
pub use frame_support::{
	...
	traits::{
		defensive_prelude::*,UnfilteredDispatchable,
...
pub struct CollectiveParams<T: Config, U> {
	pub call_pass: Box<T::RuntimeCallv>,
	pub call_fail: Box<T::RuntimeCallv>,
	pub index: u32,
	pub call: U,
	pub hash: T::Hash,
}
...
pub struct VotingProposal<T: Config, U> {
	...
	pub proposal_call: Box<T::RuntimeCallv>,
	pub proposal_hash: T::Hash,
	pub collective_call: U,
	pub collective_passed_call: Box<T::RuntimeCallv>,
	pub collective_failed_call: Box<T::RuntimeCallv>,
	pub collective_index: u32,
	pub collective_hash: T::Hash,
	pub collective_step: bool,
	pub collective_closed: bool,
	pub democracy_failed_call: Box<T::RuntimeCallv>,
